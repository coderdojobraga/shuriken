...
const Home = () => (
  <>
    ...
    <div className="xl:bg-yin-yang-curve-xl bg-cover bg-center -mb-10 md:mb-0">
      ...
      <div className="bg-yin-yang-curve xl:bg-none bg-cover bg-center -mb-10 md:mb-0">
        <section className="relative">
          <div className="container w-10/12 lg:w-4/6 flex flex-col items-start m-8 lg:m-24 py-2">
            <h2 className="text-3xl font-semibold py-2">
              <span className="text-purple-500 text-3xl mr-1">|</span>O que é o
              CoderDojo Braga?
            </h2>
            <p className="text-xl mt-2">
              ...
              anos a programar. O projeto pretende mostrar como a programação
              pode ser uma força de mudança positiva no mundo.
            </p>
          </div>
        </section>
        <section className="relative flex justify-end text-white">
          <div className="container w-10/12 lg:w-4/6 flex flex-col items-end m-8 lg:m-24 py-2">
            ...
            <p className="text-xl mt-2 text-right">
              ...
              da Universidade do Minho, em Braga. São propostos diversos
              desafios aos Ninjas, consoante o nível em que se encontram, e que
              os mesmos tentam completar com a ajuda dos Mentores.
            </p>
          </div>
        </section>
      </div>
    </div>
    <section className="relative bg-dark py-5">
      <div className="flex flex-col items-start m-8 lg:mx-24 md:mt-0">
    ...
    <section className="relative bg-dark text-white py-10">
      <div className="container mx-auto">
        ...
        <div className="mx-auto text-center w-9/12 md:w-8/12 m-4 text-2xl">
          O CoderDojo Braga pretende dar a todas as crianças e jovens da região
          minhota a oportunidade de aprenderem a programar num ambiente amigável
          e divertido.
        </div>
        <img
          className="mx-auto"
