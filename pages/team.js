    ...
    <>
      ...
      <div className="mx-auto mt-12 container">
        ...
        <p className="mx-2 lg:mx-12 mt-8 text-black text-2xl text-center leading-relaxed mt-4 mb-4">
          A equipa do CoderDojo Braga é composta por alunos voluntários de vários cursos dedicados e apaixonados pelo projeto e por tecnologia. 
          Cada uma traz o seu contributo único para criar uma experiencia incrível para os Ninjas e todos envolvidos como o projeto.
          Mais do que uma equipa, todos aqueles que decidem se envolver connosco encontram uma família.
        </p>
      </div>
