                ...
                <div className="flex flex-wrap justify-center">
                    <div className="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto mt-20">
                        ...
                        <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-black">
                            Os Mentores são o coração do CoderDojo. Lorem ipsum dolor sit amet,
            ...
            <div className="mx-auto mt-12 mb-20">
                <div className="flex flex-wrap justify-center bg-white px-12 relative z-10">
                    <div className="w-full lg:w-8/12">
                        <h1 className="font-semibold text-primary text-7xl">
                            "
                        </h1>
                        <p className="text-black text-2xl leading-relaxed mt-4 mb-4">
                            Enquanto alguém que tem uma enorme paixão por tecnologia, ser mentor permite me ser o veículo de aprendizagem
                            para jovens que partilham dessa paixão, algo que me realiza particularmente. Além disso, aprendi muito e continuo
                            a aprender com aqueles que já cá estavam e me receberam de braços abertos.
                        </p>
